package hr.kraljic.web.module.management.role;
...
@Configuration
public class RoleManagerPermission extends AbstractPermission {
    private static final String PREFIX = "ROLEMANAGER_";
    ...
    public RoleManagerPermission(PermissionInitializer permissionInitializer) {
